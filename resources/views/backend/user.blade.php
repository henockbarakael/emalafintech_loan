          ...
          <div class="row">
            <div class="row mt-2 mb-4">
                <div style="height: 30px">
                  <a href="#" class="btn btn-success btn-sm pull-right"  title="Ajouter un client" data-bs-toggle="modal" data-original-title="test" data-bs-target="#add_user"><span><i class="fa fa-plus text-white"></i></span> Ajouter un utilisateur</a>
                </div>
            </div>
          </div>
      ...
      <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
          <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel2">Ajouter Un Utilisateur</h5>
          </div>
                  ...
                  <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="branche" value="" class="form-select input-air-primary digits @error('branche') is-invalid @enderror" id="e_branche">
                            ...
                            <option value="{{ $branche->bname }}">{{ $branche->bname }}</option>
                            @endforeach    
                        </select>
                      @error('branche')
                          <span class="invalid-feedback" role="alert">
