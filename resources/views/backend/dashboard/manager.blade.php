        ...
        <div class="col-sm-12 col-xl-12">
          <div class="card">
            <div class="card-body row">
              ...
              <div class="col-xl-3 col-sm-6 box-col-6">
                <div class="myshadow p-25 text-center text-white" style="background-color: rgb(255, 133, 27);">
              ...
              <div class="col-xl-3 col-sm-6 box-col-6">
                <div class="myshadow p-25 text-center text-white" style="background-color: #2196f3;">
              ...
              <div class="col-xl-6 col-sm-6 box-col-6 mt-3">
                <div class="myshadow p-25 text-center text-white" style="background-color: #119e3e;">
                  ...
                  <h5 class="m-0 f-18">{{ $solde_cdf }}</h5>
                </div>
              </div>
              <div class="col-xl-3 col-sm-6 box-col-6 mt-3">
                <div class="myshadow p-25 text-center text-white" style="background-color: rgb(255, 133, 27);">
              ...
              <div class="col-xl-6 col-sm-6 box-col-6 mt-3">
                <div class="myshadow p-25 text-center text-white" style="background-color: #119e3e;">
                  ...
                  <h5 class="m-0 f-18">{{ $solde_usd }}</h5>
                </div>
              </div>
              <div class="col-xl-3 col-sm-6 box-col-6 mt-3">
