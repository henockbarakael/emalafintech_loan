...
<head>
    ...
    <title>Emala - Type de prêt</title>
...
@endpush
@section('content')
@section('page','Type de prêt')
@section('page_1','Prêt')
@section('page_2','Type de prêt')
{!! Toastr::message() !!}
  <div class="page-body">
    ...
    <div class="container-fluid">
        <div class="row mt-2 mb-4">
            <div style="height: 30px">
              <a href="#" class="btn btn-success btn-sm pull-right"  title="Ajouter un type" data-bs-toggle="modal" data-original-title="test" data-bs-target="#add_user"><span><i class="fa fa-plus text-white"></i></span> Ajouter un type</a>
            </div>
        </div>
                ...
                <table class="display" id="basic-8">
                  ...
                  @foreach ($prets as $key => $value)
                    <tr>
                      ...
                      <td class="type_name" style="min-width: 150px">{{$value->type_name}}</td>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
          <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel2">Type de prêt</h5>
            </div>
            <div class="modal-body">
                <form class="needs-validation" action="{{route('admin.pret.type.post')}}" novalidate=""method="POST">
                    @csrf
                    <div class="row g-3">
                        <div class="col-md-12">
                            <label class="form-label" for="type">Type de prêt</label>
                            <input class="form-control input-air-primary @error('type') is-invalid @enderror" name="type"  type="text" value="{{ old('type') }}" >
                            @error('type')
                      ...
                      <div class="col-md-12">
                        ...
                        <textarea class="form-control input-air-primary @error('description') is-invalid @enderror" name="description"  type="description" value="{{ old('description') }}" ></textarea>
                        @error('description')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
      ...
      <div class="modal fade" id="edit_user" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('admin.pret.type.edit')}}" method="POST">
                    @csrf
                    <input type="hidden" name="id" id="e_id" value="">
                    <div class="row g-3">
                        <div class="col-md-12">
                            <label class="form-label" for="type">Type de prêt</label>
                            <input class="form-control input-air-primary @error('type') is-invalid @enderror" name="type" id="e_type_name"  type="text" value="{{ old('type') }}" >
                            @error('type')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                      ...
                      <div class="col-md-12">
                        <label class="form-label" for="description">Description</label>
                        <textarea class="form-control input-air-primary @error('description') is-invalid @enderror" id="e_description" name="description"  type="text" value="{{ old('description') }}" ></textarea>
                        @error('description')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
          ...
          <div class="modal-content">
            <div class="modal-body">
                <div class="text-center mt-4">
                    <h3>Supprimer ce type de prêt</h3>
                    <p>Etes-vous sûre de vouloir supprimer?</p>
                </div>
            </div>
            <div class="modal-btn">
                <form action="{{route('admin.pret.type.delete')}}" method="POST">
                    @csrf
