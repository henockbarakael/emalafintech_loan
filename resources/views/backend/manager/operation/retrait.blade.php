...
<head>
    ...
    <title>Transaction - Retrait d'argent</title>
...
@endpush
@section('content')
@section('page','Retrait')
@section('page_1','Transaction')
@section('page_2','Retrait')
{!! Toastr::message() !!}
  <div class="page-body">
                  ...
                  <div>
                        ...
                        <div class="col-sm-12">
                          <div class="media">
                            <div class="media-body m-l-20 text-right">
                              ...
                              <p>Efféctuez un retrait en toute sécurité via Emala.<br><span></span></p>
                            </div>
                          </div>
                          <!-- End Info-->
                        </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                          <div class="card">
                            <div class="card-body">
                              <form class="needs-validation" action="{{route('manager.customer.retrait.save')}}" method="POST">
                                @csrf
                                <div class="row g-3">
                                  ...
                                  <div class="col-md-12">
                                    <label class="form-label" for="compte">Dans quel compte voulez-vous effectuer ce retrait?</label>
