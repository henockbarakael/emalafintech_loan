                  ...
                  <div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                          <div class="card">
                            <div class="card-body">
                              <form class="needs-validation" action="{{route('manager.customer.depot.save')}}" method="POST">
                                @csrf
                                <div class="row g-3">
                                  ...
                                  <div class="col-md-4 mt-4">
                                    ...
                                    <input readonly class="form-control input-air-primary" value="{{$pret->loan_amount}}" name="loan_amount" value="" id="loan_amount" type="text">
                                  </div>
                                  <div class="col-md-4 mt-4">
                                    <label class="form-label" for="validationCustom01">Total à rembouser</label>
                                    <input readonly class="form-control input-air-primary" name="principal_paid" value="{{$pret->principal_paid}}" id="principal_paid" type="text">
                                  </div>
                                  <div class="col-md-4 mt-4">
                                    <label class="form-label" for="validationCustom01">Devise</label>
                                    <input readonly class="form-control input-air-primary" name="loan_currency" value="{{$pret->loan_currency}}" id="loan_currency" type="text">
                                  </div>
