                ...
                <table class="display" id="basic-8">
                  <thead>
                    <tr>
                      ...
                      <th style="min-width: 100px">Montant/Echéance</th>
                      <th style="min-width: 100px">Début paiement</th>
                      <th style="min-width: 80px">Echéance</th>
                      <th>Devise</th>
                      <th>Durée</th>
                      {{-- <th>Type</th> --}}
                  ...
                  @foreach ($prets as $key => $value)
                    <tr>
                      ...
                      <td class="premier_echeance">{{date('d-m-Y', strtotime($value->premier_echeance))}}</td>
