                ...
                <table class="display" id="basic-8">
                  ...
                  @foreach ($customers as $key => $value)
                    <tr>
                      ...
                      <td class="phone_number"><a href="{{ url('manager/compte-client/'.Crypt::encrypt($value->id)) }}">{{$value->phone_number}}</a></td>
      ...
      <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
              <form action="{{route('manager.customer.add')}}" method="POST">
                  @csrf
    ...
    <div class="modal fade" id="edit_user" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
              <form action="{{route('manager.customer.edit')}}" method="POST">
                  @csrf
    ...
    <div class="modal fade" id="delete_user" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <div class="modal-btn">
              <form action="{{route('manager.customer.delete')}}" method="POST">
                  @csrf
