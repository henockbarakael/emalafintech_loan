    ...
    <div class="container-fluid">
        <div class="row mt-2 mb-4">
            <div style="height: 30px">
              <a href="#" class="btn btn-success btn-sm pull-right"  title="Ajouter un wallet" data-bs-toggle="modal" data-original-title="test" data-bs-target="#add_user"><span><i class="fa fa-plus text-white"></i></span> Ajouter un wallet</a>
            </div>
        </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
          <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel2">Créer Un Wallet</h5>
            </div>
            <div class="modal-body">
                <form action="{{route('admin.wallet-agence.add')}}" method="POST">
                    @csrf
                    <div class="row g-3">
                      <div class="col-md-12">
                        <label class="form-label" for="branche_id">Agence</label>
                        <select name="branche_id" value="" class="form-select input-air-primary digits @error('branche_id') is-invalid @enderror" id="e_branche_id">
                            <option selected disabled> -- Choisir une agence --</option>
                            @foreach ($branches as $branche )
                            <option value="{{ $branche->id }}">{{ $branche->bname }}</option>
                            @endforeach  
                        </select>
                      @error('branche_id')
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('admin.wallet-agence.topup')}}" method="POST">
                    @csrf
                    <input type="hidden" name="w_type" id="e_w_type" value="">
                    <div class="row g-3">
                      <div class="col-md-6">
                        <label class="form-label" for="w_code">Balance CDF</label>
                      ...
                      <div class="col-md-6">
                        <label class="form-label" for="w_code">Balance USD</label>
...
<script src="{{ asset('backend/js/script.js')}}"></script>
    ...
    <script>
        $(document).on('click','.userUpdate',function()
        {
            ...
            $('#e_w_type').val(_this.find('.w_type').text());
