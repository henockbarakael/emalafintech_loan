<div class="page-header">
    <div class="header-wrapper row m-0">
      ...
      <div class="header-logo-wrapper col-auto p-0">
        <div class="logo-wrapper"><a href="#"><img class="img-fluid" src="{{ asset('backend/images/logo/logo.png')}}" alt=""></a></div>
      ...
      <div class="nav-right col-8 pull-right right-header p-0">
        <ul class="nav-menus">
          ...
          @php
           $users = \App\Models\UserInfo::where('user_id',Auth::user()->id)->first();
   
          @endphp
          <li class="maximize"><a class="text-dark" href="#!" onclick="javascript:toggleFullScreen()"><i data-feather="maximize"></i></a></li>
          <li class="profile-nav onhover-dropdown p-0 me-0">
            <div class="media profile-media"><img class="b-r-10" src="{{ URL::to('backend/images/user/'. Auth::user()->avatar) }}" alt="">
              <div class="media-body"><span>{{$users->firstname." ".$users->lastname}}</span>
