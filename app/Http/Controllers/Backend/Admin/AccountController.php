...
class AccountController extends Controller
{
    ...
    public function client($id){
        ...
        return view('backend.customer.account',compact('transactions','id_user','avatar','role_name','city','address','phone_number','join_date','lastname','firstname','c_bcdf','c_busd','s_bcdf','s_busd','cnumber','snumber'));
    ...
    public function client_depot($id){
        ...
        $transactions = Transaction::where(['transaction_from'=>$phone_number])->get();
        return view('backend.admin.operation.depot',compact('transactions','id_user','avatar','role_name','city','address','phone_number','join_date','lastname','firstname','c_bcdf','c_busd','s_bcdf','s_busd','cnumber','snumber'));
    ...
    public function client_retrait($id){
        ...
        $transactions = Transaction::where(['transaction_from'=>$phone_number])->get();
        return view('backend.admin.operation.retrait',compact('transactions','id_user','avatar','role_name','city','address','phone_number','join_date','lastname','firstname','c_bcdf','c_busd','s_bcdf','s_busd','cnumber','snumber'));
    ...
    public function client_transfert($id){
        ...
        $transactions = Transaction::where(['transaction_from'=>$phone_number])->get();
        return view('backend.admin.operation.transfert',compact('receiver','transactions','id_user','avatar','role_name','city','address','phone_number','join_date','lastname','firstname','c_bcdf','c_busd','s_bcdf','s_busd','cnumber','snumber'));
